...
export default function Projects() {
    const projectDetails = [
        ...
        },
        {
            id: 2,
            title: "TIME-MACHINE",
            desc: "A project management and time tracking application.",
            style: "shadow-[#AAC9AF]",
        ...
        },
        {
            ...
            desc: "A personal expense tracking and budgeting application.",
            style: "shadow-[#8D60FB]",
        ...
        ({ id, title, desc, style, repoLink, link, imgSrc }) => (
            ...
            >
                ...
                <div className="w-[90%] mx-4 my-4">
                    <img src={imgSrc} alt={title} className="rounded-lg object-contain" />
                </div>
